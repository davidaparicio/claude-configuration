...
For the surrounding decisions — whether to animate at all, easing, duration, springs, interruptibility — use the core `animate` guide. For reduced motion, load the [accessibility mode](../animation-accessibility/guide.md).
