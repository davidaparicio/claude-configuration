...
For the surrounding decisions — whether to animate at all, easing, duration, springs — use the core `animate` guide. For frame budget and GPU concerns, load the [performance mode](../animation-performance/guide.md).
