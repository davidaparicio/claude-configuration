...
The components built in the Framer Motion module. Each is a small stack of the primitives in [guide.md](guide.md) — read them for the technique, not the markup.
