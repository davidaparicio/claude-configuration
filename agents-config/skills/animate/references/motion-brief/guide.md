...
Within `animate`, implementation follows the core or implementation mode, [review mode](../review-animations/guide.md) audits the result, and [vocabulary mode](../animation-vocabulary/guide.md) names an effect the user describes loosely.
