...
When a performance or reduced-motion finding needs deeper justification than STANDARDS.md carries, load the [performance](../animation-performance/guide.md) or [accessibility](../animation-accessibility/guide.md) mode.
