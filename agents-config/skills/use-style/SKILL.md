...
| `super-simple` | `.agents/styles/super-simple-theme.md` | Sales letter. White canvas, Inter, highlighter marks, blue `#258eff` pills, numbered steps. Reference: `/aibuilder/v2`. |
