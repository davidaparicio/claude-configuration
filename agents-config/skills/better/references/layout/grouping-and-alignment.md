...
- Numbers in tables right-align to the trailing edge (see [typography](../typography/guide.md) for tabular figures); text left-aligns to the leading edge.
...
- One primary action per view (see [colors](../colors/guide.md) for how color enforces this).
