...
When text appears low-contrast, use [colors](../colors/guide.md) to measure the rendered foreground/background pair and [accessibility](../accessibility/guide.md) to classify the applicable requirement. Changing the project's colors remains a design decision unless the user asks for remediation.
